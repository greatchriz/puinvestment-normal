            ...
            <div class="container">
                ...
                <div class="grid md:grid-cols-3 grid-cols-1 mt-8 gap-[30px]">
                    <div class="group text-center">
                        <div class="w-20 h-20 bg-indigo-600/5 text-indigo-600 rounded-lg ltr:rotate-[15deg] rtl:-rotate-[15deg] flex align-middle justify-center items-center shadow-sm dark:shadow-gray-800 mx-auto">
                            <i data-feather="pie-chart" class="w-7 h-7 ltr:-rotate-[15deg] rtl:rotate-[15deg]"></i>
                        </div>
                    ...
                    <div class="group text-center">
                        <div class="w-20 h-20 bg-indigo-600/5 text-indigo-600 rounded-lg ltr:rotate-[15deg] rtl:-rotate-[15deg] flex align-middle justify-center items-center shadow-sm dark:shadow-gray-800 mx-auto">
                            <i data-feather="briefcase" class="w-7 h-7 ltr:-rotate-[15deg] rtl:rotate-[15deg]"></i>
                        </div>
                    ...
                    <div class="group text-center">
                        <div class="w-20 h-20 bg-indigo-600/5 text-indigo-600 rounded-lg ltr:rotate-[15deg] rtl:-rotate-[15deg] flex align-middle justify-center items-center shadow-sm dark:shadow-gray-800 mx-auto">
                            <i data-feather="target" class="w-7 h-7 ltr:-rotate-[15deg] rtl:rotate-[15deg]"></i>
                        </div>
