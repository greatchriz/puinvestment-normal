            ...
            <div class="lg:col-span-8 md:col-span-7">
                ...
                >
                    ...
                    {include file="sections/faq/faq-detail.tpl"
                        ...
                        accordionHash="#accordion-collapse-body-5"
                        svg="<svg
                                data-accordion-icon
                        ...
                        title="How do I invest in Puinvestment?"
                        content="To make a investment you must first become a member of  Puinvestment, by registering in the company. Once you are signed up, you can make your deposits. You can login using the member username and password you receive when signup"
                    }
                    </div>
                </div>
            </div>
