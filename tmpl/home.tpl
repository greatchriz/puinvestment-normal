            ...
            <div class="container">
                <div class="lg:col-span-4">
                    <!-- Content -->
                        ...
                        <div class="mt-6">
                            <a href="https://www.northdata.com/PU+Investment+GmbH,+Glash%C3%BCtten/Amtsgericht+K%C3%B6nigstein+HRB+10633" class="text-lg font-medium  transition-all duration-500 ease-in-out">Company Registeration</a>
                            <p class="text-slate-400 transition-all duration-500 ease-in-out mt-3">Click to view certificate of company registeration</p>
                        </div>
                    </div>
                    <!-- Content -->
                </div>
