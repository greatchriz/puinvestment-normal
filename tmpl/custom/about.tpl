                ...
                <div class="lg:col-span-4">
                    ...
                    <div class="text-center md:px-6">
                        <div class="content mt-7">
                            <a href="page-services.html" class="title h5 text-lg font-medium hover:text-indigo-600">How it all started.</a>
                            ...
                            <p class="text-slate-400 mt-3">It all started in 2014, when a group of cryptocurrency enthusiasts came together to explore the potential of digital assets. At the time, the digital asset market was still in its infancy, and many people were skeptical of its potential. But we saw something different: we saw an opportunity.</p>

                            <p class="text-slate-400 mt-3">Over the next few years, we worked tirelessly to build a platform that could help people invest in digital assets. We focused on developing a user-friendly trading platform that could provide our clients with access to a wide range of digital assets, as well as the tools and resources they needed to make informed investment decisions.</p>

                            <p class="text-slate-400 mt-3">Our efforts paid off, and by 2017, we had become a trusted name in the digital asset market. That year, we launched our investment management services, which were designed to help our clients build diversified portfolios of digital assets that aligned with their investment goals and risk tolerance.</p>
